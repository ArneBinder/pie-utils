...
from pie_utils.hydra import InstantiationException, resolve_target


def test_resolve_target_string():
    target_str = "pie_utils.hydra.resolve_target"
...
def test_resolve_target_from_src():
    resolve_target("src.pie_utils.hydra.resolve_target")
